...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 1b 78 10 80 	movl   $0x8010781b,(%esp)
...
80100cff:	e8 1c 59 00 00       	call   80106620 <switchuvm>
  freevm(oldpgdir);
80100d04:	89 34 24             	mov    %esi,(%esp)
80100d07:	e8 94 5c 00 00       	call   801069a0 <freevm>
  return 0;
...
80103875:	e8 86 32 00 00       	call   80106b00 <copyuvm>
...
8010388a:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
8010388c:	8b 79 18             	mov    0x18(%ecx),%edi
8010388f:	89 c8                	mov    %ecx,%eax
  np->parent = curproc;
80103891:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
80103894:	8b 73 18             	mov    0x18(%ebx),%esi
80103897:	b9 13 00 00 00       	mov    $0x13,%ecx
8010389c:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
8010389e:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801038a0:	8b 40 18             	mov    0x18(%eax),%eax
...
80103b86:	e8 65 fe ff ff       	call   801039f0 <sched>
  panic("zombie exit");
80103b8b:	c7 04 24 dd 73 10 80 	movl   $0x801073dd,(%esp)
80103b92:	e8 c9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103b97:	c7 04 24 d0 73 10 80 	movl   $0x801073d0,(%esp)
...
80103c7e:	c7 04 24 ef 73 10 80 	movl   $0x801073ef,(%esp)
80103c85:	e8 d6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c8a:	c7 04 24 e9 73 10 80 	movl   $0x801073e9,(%esp)
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 1b 78 10 80 	movl   $0x8010781b,(%esp)
...
80103e9a:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103e9d:	ba 00 74 10 80       	mov    $0x80107400,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ea2:	77 11                	ja     80103eb5 <procdump+0x55>
80103ea4:	8b 14 85 60 74 10 80 	mov    -0x7fef8ba0(,%eax,4),%edx
      state = "???";
80103eab:	b8 00 74 10 80       	mov    $0x80107400,%eax
...
80103ec0:	c7 04 24 04 74 10 80 	movl   $0x80107404,(%esp)
...
80103f09:	c7 04 24 41 6e 10 80 	movl   $0x80106e41,(%esp)
...
80103f3a:	c7 44 24 04 78 74 10 	movl   $0x80107478,0x4(%esp)
80103f41:	80 
...
80104197:	eb ac                	jmp    80104145 <acquire+0x15>
    panic("acquire");
80104199:	c7 04 24 83 74 10 80 	movl   $0x80107483,(%esp)
...
801041f9:	c3                   	ret    
    panic("popcli");
801041fa:	c7 04 24 a2 74 10 80 	movl   $0x801074a2,(%esp)
80104201:	e8 5a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104206:	c7 04 24 8b 74 10 80 	movl   $0x8010748b,(%esp)
...
8010422f:	75 0f                	jne    80104240 <release+0x20>
    panic("release");
80104231:	c7 04 24 a9 74 10 80 	movl   $0x801074a9,(%esp)
...
80104567:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  //struct proc *curproc = myproc();		// rip sz, need to change to user stack now :(
...
8010462d:	8b 14 85 e0 74 10 80 	mov    -0x7fef8b20(,%eax,4),%edx
...
80104656:	c7 04 24 b1 74 10 80 	movl   $0x801074b1,(%esp)
...
801047e0:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
801047e7:	80 
...
801047fb:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104802:	80 
...
80104811:	79 89                	jns    8010479c <create+0xdc>
      panic("create dots");
80104813:	c7 04 24 4f 75 10 80 	movl   $0x8010754f,(%esp)
8010481a:	e8 41 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010481f:	c7 04 24 5e 75 10 80 	movl   $0x8010755e,(%esp)
80104826:	e8 35 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010482b:	c7 04 24 40 75 10 80 	movl   $0x80107540,(%esp)
...
80104bd1:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104bd8:	80 
...
80104be9:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104bf0:	80 
...
80104d3d:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
80104d44:	e8 17 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d49:	c7 04 24 92 75 10 80 	movl   $0x80107592,(%esp)
80104d50:	e8 0b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d55:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
...
80105209:	e8 d2 1b 00 00       	call   80106de0 <shm_open>
}
8010520e:	c9                   	leave  
8010520f:	c3                   	ret    
    return -1;
...
80105243:	e8 a8 1b 00 00       	call   80106df0 <shm_close>
}
80105248:	c9                   	leave  
80105249:	c3                   	ret    
...
80105489:	c7 44 24 04 a1 75 10 	movl   $0x801075a1,0x4(%esp)
80105490:	80 
...
8010551e:	77 28                	ja     80105548 <trap+0x48>
80105520:	ff 24 85 9c 76 10 80 	jmp    *-0x7fef8964(,%eax,4)
80105527:	90                   	nop
...
80105533:	b8 fe ff ff 7f       	mov    $0x7ffffffe,%eax
    uint numPG = myproc()->stackSize + 1;
80105538:	83 c2 01             	add    $0x1,%edx
    if(faultAddr >= USERSTACKBASE - ((PGSIZE * numPG) + 1))
8010553b:	c1 e2 0c             	shl    $0xc,%edx
8010553e:	29 d0                	sub    %edx,%eax
80105540:	39 f0                	cmp    %esi,%eax
80105542:	0f 86 08 02 00 00    	jbe    80105750 <trap+0x250>
		break;
	}
...
8010554f:	0f 84 4d 02 00 00    	je     801057a2 <trap+0x2a2>
80105555:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105559:	0f 84 43 02 00 00    	je     801057a2 <trap+0x2a2>
...
80105562:	8b 53 38             	mov    0x38(%ebx),%edx
80105565:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105568:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010556b:	e8 00 e1 ff ff       	call   80103670 <cpuid>
80105570:	8b 73 30             	mov    0x30(%ebx),%esi
80105573:	89 c7                	mov    %eax,%edi
80105575:	8b 43 34             	mov    0x34(%ebx),%eax
80105578:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010557b:	e8 10 e1 ff ff       	call   80103690 <myproc>
80105580:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105583:	e8 08 e1 ff ff       	call   80103690 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105588:	8b 4d d8             	mov    -0x28(%ebp),%ecx
8010558b:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
8010558f:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801055b2:	c7 04 24 58 76 10 80 	movl   $0x80107658,(%esp)
801055b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801055bd:	e8 8e b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801055c2:	e8 c9 e0 ff ff       	call   80103690 <myproc>
801055c7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
801055ce:	e8 bd e0 ff ff       	call   80103690 <myproc>
801055d3:	85 c0                	test   %eax,%eax
801055d5:	74 0c                	je     801055e3 <trap+0xe3>
801055d7:	e8 b4 e0 ff ff       	call   80103690 <myproc>
801055dc:	8b 50 24             	mov    0x24(%eax),%edx
801055df:	85 d2                	test   %edx,%edx
801055e1:	75 4d                	jne    80105630 <trap+0x130>
    exit();
...
801055ea:	74 0f                	je     801055fb <trap+0xfb>
...
801055f9:	74 4d                	je     80105648 <trap+0x148>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801055fb:	e8 90 e0 ff ff       	call   80103690 <myproc>
80105600:	85 c0                	test   %eax,%eax
80105602:	74 1d                	je     80105621 <trap+0x121>
80105604:	e8 87 e0 ff ff       	call   80103690 <myproc>
80105609:	8b 40 24             	mov    0x24(%eax),%eax
8010560c:	85 c0                	test   %eax,%eax
8010560e:	74 11                	je     80105621 <trap+0x121>
80105610:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105614:	83 e0 03             	and    $0x3,%eax
80105617:	66 83 f8 03          	cmp    $0x3,%ax
8010561b:	0f 84 e8 00 00 00    	je     80105709 <trap+0x209>
    exit();
}
...
8010563b:	75 a6                	jne    801055e3 <trap+0xe3>
    exit();
8010563d:	e8 4e e4 ff ff       	call   80103a90 <exit>
80105642:	eb 9f                	jmp    801055e3 <trap+0xe3>
...
80105650:	75 a9                	jne    801055fb <trap+0xfb>
    yield();
80105652:	e8 59 e5 ff ff       	call   80103bb0 <yield>
80105657:	eb a2                	jmp    801055fb <trap+0xfb>
80105659:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105660:	e8 0b e0 ff ff       	call   80103670 <cpuid>
80105665:	85 c0                	test   %eax,%eax
80105667:	0f 84 b3 00 00 00    	je     80105720 <trap+0x220>
8010566d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105670:	e8 fb d0 ff ff       	call   80102770 <lapiceoi>
    break;
80105675:	e9 54 ff ff ff       	jmp    801055ce <trap+0xce>
8010567a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    kbdintr();
80105680:	e8 3b cf ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
80105685:	e8 e6 d0 ff ff       	call   80102770 <lapiceoi>
    break;
8010568a:	e9 3f ff ff ff       	jmp    801055ce <trap+0xce>
8010568f:	90                   	nop
    uartintr();
80105690:	e8 6b 02 00 00       	call   80105900 <uartintr>
    lapiceoi();
80105695:	e8 d6 d0 ff ff       	call   80102770 <lapiceoi>
    break;
8010569a:	e9 2f ff ff ff       	jmp    801055ce <trap+0xce>
8010569f:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801056a0:	8b 7b 38             	mov    0x38(%ebx),%edi
801056a3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801056a7:	e8 c4 df ff ff       	call   80103670 <cpuid>
801056ac:	c7 04 24 ac 75 10 80 	movl   $0x801075ac,(%esp)
...
801056bf:	e8 8c af ff ff       	call   80100650 <cprintf>
    lapiceoi();
801056c4:	e8 a7 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056c9:	e9 00 ff ff ff       	jmp    801055ce <trap+0xce>
801056ce:	66 90                	xchg   %ax,%ax
    ideintr();
801056d0:	e8 9b c9 ff ff       	call   80102070 <ideintr>
...
801056ea:	75 2c                	jne    80105718 <trap+0x218>
    myproc()->tf = tf;
801056ec:	e8 9f df ff ff       	call   80103690 <myproc>
801056f1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801056f4:	e8 17 ef ff ff       	call   80104610 <syscall>
    if(myproc()->killed)
801056f9:	e8 92 df ff ff       	call   80103690 <myproc>
801056fe:	8b 48 24             	mov    0x24(%eax),%ecx
80105701:	85 c9                	test   %ecx,%ecx
80105703:	0f 84 18 ff ff ff    	je     80105621 <trap+0x121>
}
...
8010570f:	5d                   	pop    %ebp
      exit();
80105710:	e9 7b e3 ff ff       	jmp    80103a90 <exit>
80105715:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105718:	e8 73 e3 ff ff       	call   80103a90 <exit>
8010571d:	eb cd                	jmp    801056ec <trap+0x1ec>
8010571f:	90                   	nop
      acquire(&tickslock);
80105720:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105727:	e8 04 ea ff ff       	call   80104130 <acquire>
      wakeup(&ticks);
8010572c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105733:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010573a:	e8 41 e6 ff ff       	call   80103d80 <wakeup>
      release(&tickslock);
...
80105755:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
8010575b:	8d 56 08             	lea    0x8(%esi),%edx
8010575e:	89 54 24 08          	mov    %edx,0x8(%esp)
80105762:	89 74 24 04          	mov    %esi,0x4(%esp)
80105766:	8b 40 04             	mov    0x4(%eax),%eax
80105769:	89 04 24             	mov    %eax,(%esp)
8010576c:	e8 0f 11 00 00       	call   80106880 <allocuvm>
80105771:	85 c0                	test   %eax,%eax
80105773:	75 13                	jne    80105788 <trap+0x288>
			cprintf("\n Error orrcured in allocuvm() ! \n");
80105775:	c7 04 24 d0 75 10 80 	movl   $0x801075d0,(%esp)
8010577c:	e8 cf ae ff ff       	call   80100650 <cprintf>
			break;
80105781:	e9 48 fe ff ff       	jmp    801055ce <trap+0xce>
80105786:	66 90                	xchg   %ax,%ax
		myproc()->stackSize += 1;
80105788:	e8 03 df ff ff       	call   80103690 <myproc>
8010578d:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
		cprintf("\n Stack size is successfully increased by 1 \n");
80105791:	c7 04 24 f4 75 10 80 	movl   $0x801075f4,(%esp)
80105798:	e8 b3 ae ff ff       	call   80100650 <cprintf>
		break;
8010579d:	e9 2c fe ff ff       	jmp    801055ce <trap+0xce>
801057a2:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057a5:	8b 73 38             	mov    0x38(%ebx),%esi
801057a8:	e8 c3 de ff ff       	call   80103670 <cpuid>
801057ad:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057b1:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057b5:	89 44 24 08          	mov    %eax,0x8(%esp)
801057b9:	8b 43 30             	mov    0x30(%ebx),%eax
801057bc:	c7 04 24 24 76 10 80 	movl   $0x80107624,(%esp)
801057c3:	89 44 24 04          	mov    %eax,0x4(%esp)
801057c7:	e8 84 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057cc:	c7 04 24 a6 75 10 80 	movl   $0x801075a6,(%esp)
801057d3:	e8 88 ab ff ff       	call   80100360 <panic>
...
801058c7:	00 
  for(p="xv6...\n"; *p; p++)
801058c8:	bb 64 77 10 80       	mov    $0x80107764,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801065f1:	c3                   	ret    
      panic("remap");
801065f2:	c7 04 24 6c 77 10 80 	movl   $0x8010776c,(%esp)
...
80106701:	c7 04 24 72 77 10 80 	movl   $0x80107772,(%esp)
80106708:	e8 53 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010670d:	c7 04 24 9d 77 10 80 	movl   $0x8010779d,(%esp)
80106714:	e8 47 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106719:	c7 04 24 88 77 10 80 	movl   $0x80107788,(%esp)
...
801067ae:	c7 04 24 b1 77 10 80 	movl   $0x801077b1,(%esp)
...
80106862:	c7 04 24 cb 77 10 80 	movl   $0x801077cb,(%esp)
80106869:	e8 f2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010686e:	c7 04 24 6c 78 10 80 	movl   $0x8010786c,(%esp)
...
80106912:	c7 04 24 e9 77 10 80 	movl   $0x801077e9,(%esp)
...
80106940:	c7 04 24 01 78 10 80 	movl   $0x80107801,(%esp)
...
80106a03:	e9 d8 b8 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106a08:	c7 04 24 1d 78 10 80 	movl   $0x8010781d,(%esp)
...
80106aeb:	c3                   	ret    
    panic("clearpteu");
80106aec:	c7 04 24 2e 78 10 80 	movl   $0x8010782e,(%esp)
...
80106b3d:	e8 ce d7 ff ff       	call   80104310 <memmove>
...
80106b87:	0f 84 0a 01 00 00    	je     80106c97 <copyuvm+0x197>
    if(!(*pte & PTE_P))
80106b8d:	8b 30                	mov    (%eax),%esi
80106b8f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b95:	0f 84 f0 00 00 00    	je     80106c8b <copyuvm+0x18b>
    pa = PTE_ADDR(*pte);
...
80106bd0:	8b 45 10             	mov    0x10(%ebp),%eax
80106bd3:	85 c0                	test   %eax,%eax
80106bd5:	0f 84 9e 00 00 00    	je     80106c79 <copyuvm+0x179>
80106bdb:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106be0:	eb 58                	jmp    80106c3a <copyuvm+0x13a>
...
80106c2c:	78 8d                	js     80106bbb <copyuvm+0xbb>
  for(i = USERSTACKBASE - PGSIZE + 1; stackSize > 0; i -= PGSIZE, stackSize--)
80106c2e:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c34:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80106c38:	74 3f                	je     80106c79 <copyuvm+0x179>
	if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c3a:	8b 45 08             	mov    0x8(%ebp),%eax
80106c3d:	31 c9                	xor    %ecx,%ecx
80106c3f:	89 da                	mov    %ebx,%edx
80106c41:	e8 4a f7 ff ff       	call   80106390 <walkpgdir>
80106c46:	85 c0                	test   %eax,%eax
80106c48:	74 4d                	je     80106c97 <copyuvm+0x197>
    if(!(*pte & PTE_P))
80106c4a:	8b 30                	mov    (%eax),%esi
80106c4c:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c52:	74 37                	je     80106c8b <copyuvm+0x18b>
    pa = PTE_ADDR(*pte);
80106c54:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c56:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c5c:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c5f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c65:	e8 26 b8 ff ff       	call   80102490 <kalloc>
80106c6a:	85 c0                	test   %eax,%eax
80106c6c:	89 c6                	mov    %eax,%esi
80106c6e:	0f 85 74 ff ff ff    	jne    80106be8 <copyuvm+0xe8>
80106c74:	e9 42 ff ff ff       	jmp    80106bbb <copyuvm+0xbb>
80106c79:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106c7c:	83 c4 2c             	add    $0x2c,%esp
80106c7f:	5b                   	pop    %ebx
80106c80:	5e                   	pop    %esi
80106c81:	5f                   	pop    %edi
80106c82:	5d                   	pop    %ebp
...
80106c86:	e9 3d ff ff ff       	jmp    80106bc8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106c8b:	c7 04 24 52 78 10 80 	movl   $0x80107852,(%esp)
80106c92:	e8 c9 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c97:	c7 04 24 38 78 10 80 	movl   $0x80107838,(%esp)
80106c9e:	e8 bd 96 ff ff       	call   80100360 <panic>
...
80106d2c:	e8 df d5 ff ff       	call   80104310 <memmove>
    len -= n;
    buf += n;
...
80106d86:	c7 44 24 04 90 78 10 	movl   $0x80107890,0x4(%esp)
80106d8d:	80 
80106d8e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d95:	e8 a6 d2 ff ff       	call   80104040 <initlock>
  acquire(&(shm_table.lock));
80106d9a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106da1:	e8 8a d3 ff ff       	call   80104130 <acquire>
...
80106dd5:	e8 46 d4 ff ff       	call   80104220 <release>
}
80106dda:	c9                   	leave  
80106ddb:	c3                   	ret    
